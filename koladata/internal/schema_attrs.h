...
inline constexpr absl::string_view kSchemaAttr = "__schema__";

// Schema attributes.
//
// Schema of the values of a List.
inline constexpr absl::string_view kListItemsSchemaAttr = "__items__";
// Schema of the keys of a Dict.
inline constexpr absl::string_view kDictKeysSchemaAttr = "__keys__";
// Schema of the values of a Dict.
inline constexpr absl::string_view kDictValuesSchemaAttr = "__values__";
...
inline constexpr absl::string_view kImplicitSchemaSeed = "__implicit_schema__";
