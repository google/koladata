...
//
#ifndef KOLADATA_OPERATORS_JSON_STREAM_PARSER_H_
#define KOLADATA_OPERATORS_JSON_STREAM_PARSER_H_
...
/* Utility class for parsing JSON streams.
...
#endif  // KOLADATA_OPERATORS_JSON_STREAM_PARSER_H_
