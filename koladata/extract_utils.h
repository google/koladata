...
// If `casting_callback` is provided, the extracted data would be casted during
// the extraction  to the types specified in the schema. Only the struct schema
// is supported with this option.
