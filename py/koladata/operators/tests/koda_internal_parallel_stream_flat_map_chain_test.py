...
class KodaInternalParallelStreamFlatMapChainTest(absltest.TestCase):
  ...
  def test_basic(self):
    ...
    res = kde_internal.parallel.stream_flat_map_chain(  # pyrefly: ignore[missing-attribute]
  ...
  def test_view(self):
    self.assertTrue(
        view.has_koda_view(
            kde_internal.parallel.stream_flat_map_chain(  # pyrefly: ignore[missing-attribute]
