...
class CoreOrdinalRankTest(parameterized.TestCase):
  ...
  @parameterized.parameters(
      ...
      # x.ndim = 1
      (ds([0, 3, None, 6]), False, 0, ds([0, 0, None, 0], dtype=INT64)),
      (ds([0, 3, None, 6]), False, 1, ds([0, 1, None, 2], dtype=INT64)),
      (ds([0, 3, None, 6]), True, 0, ds([0, 0, None, 0], dtype=INT64)),
      (ds([0, 3, None, 6]), True, 1, ds([2, 1, None, 0], dtype=INT64)),
      # x.ndim = 2
      (
          ds([[0, 3, None, 6], [5, None, 2, 1]]),
          False,
          0,
          ds([[0, 0, None, 0], [0, None, 0, 0]], dtype=INT64),
      ),
      (
          ds([[0, 3, None, 6], [5, None, 2, 1]]),
          False,
          1,
          ds([[0, 1, None, 2], [2, None, 1, 0]], dtype=INT64),
      ),
      (
          ds([[0, 3, None, 6], [5, None, 2, 1]]),
          False,
          2,
          ds([[0, 3, None, 5], [4, None, 2, 1]], dtype=INT64),
      ),
      (
          ds([[0, 3, None, 6], [5, None, 2, 1]]),
          True,
      ...
      (
          ...
          True,
          1,
          ds([[2, 1, None, 0], [0, None, 1, 2]], dtype=INT64),
      ),
      (
          ds([[0, 3, None, 6], [5, None, 2, 1]]),
          True,
          2,
          ds([[5, 2, None, 0], [1, None, 3, 4]], dtype=INT64),
      ),
      # descending and ndim as DataItems
      (ds([0, 3, None, 6]), ds(False), ds(1), ds([0, 1, None, 2], dtype=INT64)),
      # OBJECT, ANY schemas
      (
  ...
  @parameterized.parameters(
      # x.ndim = 0
      (ds(0), ds(1), 0, ds(0, dtype=INT64)),
      (ds(0), ds(2), 0, ds(0, dtype=INT64)),
      # x.ndim = 1
      (ds([1, 1, 1, 6]), ds([2, 2, 0, 6]), 0, ds([0, 0, 0, 0], dtype=INT64)),
      (ds([1, 1, 1, 6]), ds([2, 2, 0, 6]), 1, ds([1, 2, 0, 3], dtype=INT64)),
      # x.ndim = 2
      (
          ds([[1, 1, 1, 6], [5, 2, 2, 2]]),
          ds([[2, 2, 0, 6], [5, 0, 0, 1]]),
          0,
          ds([[0, 0, 0, 0], [0, 0, 0, 0]], dtype=INT64),
      ),
      (
          ds([[1, 1, 1, 6], [5, 2, 2, 2]]),
          ds([[2, 2, 0, 6], [5, 0, 0, 1]]),
          1,
          ds([[1, 2, 0, 3], [3, 0, 1, 2]], dtype=INT64),
      ),
      (
          ds([[1, 1, 1, 6], [5, 2, 2, 2]]),
          ds([[2, 2, 0, 6], [5, 0, 0, 1]]),
          2,
          ds([[1, 2, 0, 7], [6, 3, 4, 5]], dtype=INT64),
      ),
      # Sparse x
      (
          ds([1, None, 1, 6]),
      ...
      (
          ...
          ds([1, 2]),
          2,
          ds([[0, 1, 2, 7], [6, 3, 4, 5]], dtype=INT64),
      ),
      # INT64, OBJECT, ANY schemas
      (
          ds([1, 1, 1, 6], dtype=INT64),
          ds([2, 2, 0, 6], dtype=INT64),
          1,
          ds([1, 2, 0, 3], dtype=INT64),
      ),
      (
  ...
  @parameterized.parameters(
      # x.ndim = 1
      (ds([0, 3, None, 6]), ds([0, 1, None, 2], dtype=INT64)),
      # x.ndim = 2
      (
          ds([[0, 3, None, 6], [5, None, 2, 1]]),
          ds([[0, 1, None, 2], [2, None, 1, 0]], dtype=INT64),
