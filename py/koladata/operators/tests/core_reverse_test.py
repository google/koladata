...
class CoreUniqueTest(parameterized.TestCase):
  ...
  def test_view(self):
    self.assertTrue(view.has_data_slice_view(kde.core.reverse(I.x)))

  def test_alias(self):
    self.assertTrue(optools.equiv_to_op(kde.core.reverse, kde.reverse))
