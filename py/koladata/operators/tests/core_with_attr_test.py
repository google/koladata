...
class CoreWithAttrTest(parameterized.TestCase):
  ...
  def test_entity_as_obj_conflict(self):
    ...
    o1 = kde.core.with_attr(o, 'x', '2', update_schema=True).eval()
  ...
  def test_schema_works(self):
    ...
    o2 = kde.core.with_attr(
        o1, 'x', schema_constants.FLOAT32, update_schema=True
    ).eval()
  ...
  def test_view(self):
    self.assertTrue(view.has_data_slice_view(kde.core.with_attr(I.x, I.a, I.y)))
  ...
  def test_repr(self):
    self.assertEqual(
        ...
        'kde.core.with_attr(I.x, I.a, I.y, DataItem(False, schema: BOOLEAN))',
    )
