...
class MathSubtractTest(parameterized.TestCase):
  ...
  def test_repr(self):
    ...
    self.assertEqual(repr(kde.subtract(I.x, I.y)), 'I.x - I.y')

  def test_view(self):
    self.assertTrue(view.has_data_slice_view(kde.math.subtract(I.x, I.y)))

  def test_alias(self):
    self.assertTrue(optools.equiv_to_op(kde.math.subtract, kde.subtract))
