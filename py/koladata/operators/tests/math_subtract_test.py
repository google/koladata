...
class MathSubtractTest(parameterized.TestCase):
  ...
  def test_repr(self):
    self.assertEqual(repr(kde.math.subtract(I.x, I.y)), 'I.x - I.y')  # pyrefly: ignore[missing-attribute]

  def test_view(self):
    self.assertTrue(view.has_koda_view(kde.math.subtract(I.x, I.y)))  # pyrefly: ignore[missing-attribute]
