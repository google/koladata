...
class MathPosTest(parameterized.TestCase):
  ...
  def test_qtype_signatures(self):
    self.assertCountEqual(
        arolla.testing.detect_qtype_signatures(
            kde.math.pos,  # pyrefly: ignore[missing-attribute]
  ...
  def test_repr(self):
    self.assertEqual(repr(kde.math.pos(I.x)), '+I.x')  # pyrefly: ignore[missing-attribute]

  def test_view(self):
    self.assertTrue(view.has_koda_view(kde.math.pos(I.x)))  # pyrefly: ignore[missing-attribute]
