...
class CoreIsInTest(parameterized.TestCase):
  ...
  def test_view(self):
    self.assertTrue(view.has_data_slice_view(kde.core.isin(I.x, I.y)))

  def test_alias(self):
    self.assertTrue(optools.equiv_to_op(kde.core.isin, kde.isin))
