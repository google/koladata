...
class CoreHashItemIdTest(parameterized.TestCase):
  ...
  def test_eval(self, ids):
    hash1 = expr_eval.eval(kde.core.hash_itemid(ids))
    hash2 = expr_eval.eval(kde.core.hash_itemid(ids))
  ...
  def test_different_hash_values(self):
    hash1 = expr_eval.eval(kde.core.hash_itemid(bag().new(a=1)))
    hash2 = expr_eval.eval(kde.core.hash_itemid(bag().new(a=1)))
  ...
  def test_error(self):
    with self.assertRaisesRegex(
      ...
      kde.core.hash_itemid(ds([1, 2, 3])).eval()
