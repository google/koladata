...
CURVE = ds([[1, 5], [100, 10], [300, 20]])


class CurvesLogP1PwlCurveTest(curves_test_case.BaseCurveTestcase):

  @property
  def operator(self):
    return kde.curves.log_p1_pwl_curve  # pyrefly: ignore[missing-attribute]

  @parameterized.parameters((
      ds(3.5),
      CURVE,
      ds(6.0338, schema_constants.FLOAT64),
  ))
