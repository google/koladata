...
class SlicesTakeTest(parameterized.TestCase):
  ...
  def test_qtype_signatures(self):
    self.assertCountEqual(
        arolla.testing.detect_qtype_signatures(
            kde.slices.take,  # pyrefly: ignore[missing-attribute]
  ...
  def test_view(self):
    self.assertTrue(view.has_koda_view(kde.take(I.x, I.y)))  # pyrefly: ignore[missing-attribute]

  def test_alias(self):
    self.assertTrue(optools.equiv_to_op(kde.slices.take, kde.take))  # pyrefly: ignore[missing-attribute]
    self.assertTrue(optools.equiv_to_op(kde.slices.at, kde.take))  # pyrefly: ignore[missing-attribute]
    self.assertTrue(optools.equiv_to_op(kde.at, kde.take))  # pyrefly: ignore[missing-attribute]
