...
QTYPES = frozenset([
    (JAGGED_SHAPE, DATA_SLICE),
    (JAGGED_SHAPE, DATA_SLICE, DATA_SLICE),
    (JAGGED_SHAPE, arolla.UNSPECIFIED, DATA_SLICE),
    (JAGGED_SHAPE, DATA_SLICE, DATA_SLICE, DATA_SLICE),
    (JAGGED_SHAPE, DATA_SLICE, arolla.UNSPECIFIED, DATA_SLICE),
    (JAGGED_SHAPE, arolla.UNSPECIFIED, DATA_SLICE, DATA_SLICE),
    (JAGGED_SHAPE, arolla.UNSPECIFIED, arolla.UNSPECIFIED, DATA_SLICE),
    (JAGGED_SHAPE, DATA_SLICE, DATA_SLICE, DATA_SLICE, DATA_SLICE),
    (JAGGED_SHAPE, arolla.UNSPECIFIED, DATA_SLICE, DATA_SLICE, DATA_SLICE),
    (JAGGED_SHAPE, DATA_SLICE, arolla.UNSPECIFIED, DATA_SLICE, DATA_SLICE),
    (
        JAGGED_SHAPE,
        arolla.UNSPECIFIED,
        arolla.UNSPECIFIED,
