...
"""Tests for kde.core.present_shaped."""
...
class CorePresentShapedTest(parameterized.TestCase):
  ...
  def test_eval(self, shape, expected):
    res = expr_eval.eval(kde.core.present_shaped(shape))
  ...
  def test_view(self):
    self.assertTrue(view.has_data_slice_view(kde.core.present_shaped(I.shape)))
