...
class KodaInternalParallelFutureFromSingleValueStreamTest(absltest.TestCase):
  ...
  def test_simple(self):
    ...
    expr = kde_internal.parallel.future_from_single_value_stream(stream)  # pyrefly: ignore[missing-attribute]
  ...
  def test_qtype_signatures(self):
    ...
    arolla.testing.assert_qtype_signatures(
        kde_internal.parallel.future_from_single_value_stream,  # pyrefly: ignore[missing-attribute]
        [
  ...
  def test_view(self):
    self.assertTrue(
        view.has_koda_view(
            kde_internal.parallel.future_from_single_value_stream(I.x)  # pyrefly: ignore[missing-attribute]
        )
    )
