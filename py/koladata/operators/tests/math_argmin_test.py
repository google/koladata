...
class MathArgminTest(parameterized.TestCase):
  ...
  @parameterized.parameters(
      (ds([1, 2, None, 3]), ds(0, schema_constants.INT64)),
      (ds([None], schema_constants.INT32), ds(None, schema_constants.INT64)),
      (
          ds([[1, None], [4, 3], [None, None], []]),
      ...
      (
          ds(
              [[1.0, None], [4.0, 3.999999], [None, None], []],
      ...
      (
          ds(
              [[1.0, None], [4.0, 3.9999999], [None, None], []],
      ...
      (
          ds(
              [[1, None], [4, 3], [None, None], []],
              schema_constants.INT64,
          ),
          ds([0, 1, None, None], schema_constants.INT64),
      ),
      (
          ds([[[1.0, None], [4.0, 3.0]], [[None, None]]]),
          ds([[0, 1], [None]], schema_constants.INT64),
      ),
      (
          ds([[1, None, None], [4, 3], [None, None]]),
          arolla.unspecified(),
          ds([0, 1, None], schema_constants.INT64),
      ),
      (
  ...
  def test_eval(self, *args_and_expected):
    ...
    result = expr_eval.eval(kde.math.argmin(*args))
  ...
  def test_out_of_bounds_ndim_error(self, ndim):
    ...
    with self.assertRaisesRegex(ValueError, 'expected 0 <= ndim <= rank'):
      expr_eval.eval(kde.math.argmin(x, ndim=ndim))
