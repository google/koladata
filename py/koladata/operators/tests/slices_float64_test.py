...
class SlicesFloat64Test(parameterized.TestCase):
  ...
  @parameterized.parameters(
      ...
      ([1, 2, 3], ds([1.0, 2.0, 3.0], schema_constants.FLOAT64)),
      ([1, 2, 3.1], ds([1.0, 2.0, 3.1], schema_constants.FLOAT64)),
      (
          [1, literal_operator.literal(ds(2)), 3],
          ds([1.0, 2.0, 3.0], schema_constants.FLOAT64),
      ),
  )
