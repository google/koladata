...
def add_source_location_on_error_to_future(future, source_location):
...
def add_source_location_on_error_to_stream(stream, source_location):
...
def add_source_location_on_error_to_parallel(arg, source_location):
