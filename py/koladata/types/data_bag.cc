...
// Mode of DataBag factory function.
// * kWithBag: DataBag is passed as the first argument.
// * kNoBag: CLS is passed as the first argument.
enum class DataBagFactoryMode {
  kWithBag,
  kNoBag,
};

// Type of the first argument of DataBag factory function.
template <DataBagFactoryMode kMode>
using SelfOrClsType = std::conditional_t<kMode == DataBagFactoryMode::kWithBag,
...
PyObject* absl_nullable ProcessObjectCreation(
  ...
  if (!args.pos_only_args.empty() && FirstArgProvided(args.pos_only_args[0])) {
    ...
    RETURN_IF_ERROR(
        ((void)arolla::python::ReleasePyGIL(), adoption_queue.AdoptInto(*db)))
...
PyObject* absl_nullable PyDataBag_new_factory(SelfOrClsType<kMode> self,
  ...
  if constexpr (kMode == DataBagFactoryMode::kWithBag) {
...
absl::Status ConvertDictKeysAndValues(PyObject* py_obj,
  ...
  ASSIGN_OR_RETURN(keys,
                   DataSliceFromPyFlatList(
                       py_keys, DataSlice::JaggedShape::FlatFromSize(dict_size),
                       /*schema=*/internal::DataItem(),  // auto-detect.
                       adoption_queue));
  ASSIGN_OR_RETURN(
      values, DataSliceFromPyFlatList(
                  py_values, DataSlice::JaggedShape::FlatFromSize(dict_size),
                  /*schema=*/internal::DataItem(),  // auto-detect.
                  adoption_queue));
...
PyObject* absl_nullable PyDataBag_implode(PyObject* self, PyObject* const* args,
  ...
  ASSIGN_OR_RETURN(DataSlice res,
                   ((void)arolla::python::ReleasePyGIL(),
                    Implode(self_db, *x_ptr, ndim, itemid)),
                   arolla::python::SetPyErrFromStatus(_));
  return WrapPyDataSlice(std::move(res));
}
...
PyObject* absl_nullable PyDataBag_concat_lists(PyObject* self,
  ...
  ASSIGN_OR_RETURN(DataSlice res,
                   ((void)arolla::python::ReleasePyGIL(),
                    ConcatLists(self_db, std::move(inputs))),
                   arolla::python::SetPyErrFromStatus(_));
  return WrapPyDataSlice(std::move(res));
}
...
PyObject* absl_nullable PyDataBag_merge_inplace(PyObject* self,
  ...
  for (int i = 3; i < nargs; ++i) {
    ...
    RETURN_IF_ERROR(((void)arolla::python::ReleasePyGIL(),
                     db->MergeInplace(*other, overwrite, allow_data_conflicts,
...
PyObject* absl_nullable PyDataBag_overwriting_merge_update(PyObject* self,
  ...
  ASSIGN_OR_RETURN(auto update,
                   ((void)arolla::python::ReleasePyGIL(),
                    db->CreateOverwritingMergeUpdate(*other)),
                   arolla::python::SetPyErrFromStatus(_));
...
PyObject* absl_nullable PyDataBag_adopt_stub(PyObject* self, PyObject* ds) {
  ...
  RETURN_IF_ERROR(((void)arolla::python::ReleasePyGIL(), AdoptStub(db, *slice)))
      .With(arolla::python::SetPyErrFromStatus);
  return WrapPyDataSlice(slice->WithBag(db));
}
...
PyObject* absl_nullable PyDataBag_merge_fallbacks(PyObject* self, PyObject*) {
  ...
  const auto& db = UnsafeDataBagPtr(self);
  ASSIGN_OR_RETURN(auto res,
                   ((void)arolla::python::ReleasePyGIL(), db->MergeFallbacks()),
                   arolla::python::SetPyErrFromStatus(_));
...
PyObject* absl_nullable PyDataBag_contents_repr(PyObject* self,
  ...
  ASSIGN_OR_RETURN(
      std::string str,
      ((void)arolla::python::ReleasePyGIL(), ToStrFunc(db, triple_limit)),
      arolla::python::SetPyErrFromStatus(_));
...
PyObject* absl_nullable PyDataBag_from_proto(PyObject* self,
  ...
  ASSIGN_OR_RETURN(DataSlice result,
                   FromProtoObjects(db, py_objects, extensions, itemid, schema),
                   arolla::python::SetPyErrFromStatus(_));
...
PyObject* absl_nullable PyDataBag_get_approx_size(PyObject* self, PyObject*) {
  ...
  int64_t size = 0;
  {
    ...
    size = db->GetImpl().GetApproxTotalSize();
...
PyObject* absl_nullable PyDataBag_get_approx_byte_size(PyObject* self,
  ...
  const DataBagPtr& db = UnsafeDataBagPtr(self);
  int64_t size =
      ((void)arolla::python::ReleasePyGIL(), db->GetApproxByteSize());
  return PyLong_FromLongLong(size);
}
...
Returns:
  data_slice.DataSlice with the given attrs.)"""},
    {"obj", (PyCFunction)PyDataBag_obj_factory<DataBagFactoryMode::kWithBag>,
     METH_FASTCALL | METH_KEYWORDS,
...
Returns:
  data_slice.DataSlice with the given attrs and kd.OBJECT schema.)"""},
    {"_obj_no_bag",
     (PyCFunction)PyDataBag_obj_factory<DataBagFactoryMode::kNoBag>,
     METH_CLASS | METH_FASTCALL | METH_KEYWORDS,
...
PyObject* absl_nullable PyDataBagModule_exactly_equal(PyObject* /*module*/,
                                                      PyObject* const* args,
                                                      Py_ssize_t nargs) {
  arolla::python::DCheckPyGIL();
  arolla::python::PyCancellationScope cancellation_scope;
  if (nargs != 2) {
    PyErr_Format(PyExc_ValueError,
                 "exactly_equal accepts exactly 2 arguments, got %d", nargs);
    return nullptr;
  }
  ...
  bool res = ((void)arolla::python::ReleasePyGIL(),
