...
class DataSlice(arolla.QValue):
    ...
    def has_bag(self) -> DataItem: ...
    def with_bag(self, bag: DataBag | None, /) -> Self: ...
    def no_bag(self) -> Self: ...
    def fork_bag(self) -> Self: ...
    def freeze_bag(self) -> Self: ...
    def with_merged_bag(self) -> Self: ...
    def enriched(self, *bag: DataBag) -> Self: ...
    def updated(self, *bag: DataBag) -> Self: ...

    def get_schema(self) -> SchemaItem: ...
    def get_shape(self) -> _JaggedShape: ...
    def get_ndim(self) -> DataItem: ...
    def get_dtype(self) -> DataItem: ...
    def get_obj_schema(self) -> SchemaItem: ...
    def get_schema_name(self) -> DataItem: ...
    def is_list_schema(self) -> DataItem: ...
    def is_dict_schema(self) -> DataItem: ...
    def is_named_schema(self) -> DataItem: ...
    def is_entity_schema(self) -> DataItem: ...
    def is_struct_schema(self) -> DataItem: ...
    def is_primitive_schema(self) -> DataItem: ...
    def is_primitive(self) -> DataItem: ...
    def is_list(self) -> DataItem: ...
    def is_dict(self) -> DataItem: ...
    def is_entity(self) -> DataItem: ...
    def is_empty(self) -> DataItem: ...
    def is_mutable(self) -> DataItem: ...
    def internal_is_itemid_schema(self) -> DataItem: ...

    def with_schema(self, schema: DataSlice, /) -> Self: ...
    def set_schema(self, schema: DataSlice, /) -> Self: ...
    def with_schema_from_obj(self) -> Self: ...
    def embed_schema(self) -> Self: ...
    ...
    def strict_with_attrs(self, **attrs: Any) -> Self: ...
    def get_attr_names(self) -> DataSlice: ...
    def _dir_impl(self, *, intersection: bool | None = None) -> list[str]: ...

    def new(self, **attrs: Any) -> DataSlice: ...
    def strict_new(self, **attrs: Any) -> DataSlice: ...
    def get_item_schema(self) -> DataSlice: ...
    def get_key_schema(self) -> DataSlice: ...
    def get_value_schema(self) -> DataSlice: ...
    def get_nofollowed_schema(self) -> DataSlice: ...
    def bind(
        self, *args: Any, return_type_as: Any = ..., **kwargs: Any
    ) -> DataSlice: ...
    def clone(
        self, *, itemid: DataSlice | None = None, schema: DataSlice = None, **overrides: Any
    ) -> Self: ...
    def clone_as_full(self, *, itemid: DataSlice | None = None, **overrides: Any) -> Self: ...
    def shallow_clone(
        self, *, itemid: DataSlice | None = None, schema: DataSlice = None, **overrides: Any
    ) -> Self: ...
    def deep_clone(self, schema: DataSlice = None, **overrides: Any) -> Self: ...
    def deep_uuid(
    ...
    def get_present_keys(self) -> DataSlice: ...
    def get_values(self, key_ds: Any = None) -> DataSlice: ...
    def get_present_values(self) -> DataSlice: ...
    def with_dict_update(self, keys: Any, values: Any = None) -> Self: ...
    def with_list_append_update(self, append: Any) -> Self: ...

    def follow(self) -> Self: ...
    def extract(self, schema: DataSlice = None) -> Self: ...
    def extract_update(self, schema: DataSlice = None) -> DataBag: ...
    ...
    def __call__(self, *args: Any, return_type_as: Any = ..., **kwargs: Any) -> Any: ...
...
class DataBag(arolla.QValue):
    ...
    def uu_schema(self, seed: str = '', **attrs: Any) -> SchemaItem: ...

    def new_schema(self, **attrs: Any) -> SchemaItem: ...
    def named_schema(self, name: str | DataSlice, /, **attrs: Any) -> SchemaItem: ...
    def dict_schema(self, key_schema: DataSlice, value_schema: DataSlice) -> SchemaItem: ...
    def list_schema(self, item_schema: DataSlice) -> SchemaItem: ...
    ...
    def overwriting_merge_update(self, other_bag: DataBag, /) -> DataBag: ...
    ...
    def get_approx_byte_size(self) -> int: ...
...
class SchemaItem(DataItem):
  ...
  @overload
  def get_attr(
      self, attr_name: DataSlice, /, default: Any = None
  ) -> DataSlice: ...
