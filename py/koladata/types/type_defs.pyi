...
import types
import typing
from typing import Any, Callable, Mapping, Optional, Sequence, Iterable, TypeAlias, Iterator, Self

from arolla import arolla

NotImplementedType = types.NotImplementedType
_JaggedShape = arolla.AnyQValue
# TODO: Use kd.types.DataItem once the circular dependency is
# resolved.
_SchemaItem = arolla.AnyQValue
...
class DataSlice(arolla.QValue):
    ...
    def get_schema(self) -> _SchemaItem: ...
    def get_item_schema(self) -> _SchemaItem: ...
    def get_key_schema(self) -> _SchemaItem: ...
    def get_value_schema(self) -> _SchemaItem: ...
...
class DataBag(arolla.QValue):
    ...
    def uu_schema(self, seed: str = '', **attrs: Any) -> _SchemaItem: ...

    def new_schema(self, **attrs: Any) -> _SchemaItem: ...
    def named_schema(self, name: str | DataSlice, /, **attrs: Any) -> _SchemaItem: ...
    def dict_schema(self, key_schema: DataSlice, value_schema: DataSlice) -> _SchemaItem: ...
    def list_schema(self, item_schema: DataSlice) -> _SchemaItem: ...
