...
class DataSlice(arolla.QValue):
    ...
    def get_schema_name(self) -> DataSlice: ...
    def is_list_schema(self) -> DataSlice: ...
    def is_dict_schema(self) -> DataSlice: ...
    def is_named_schema(self) -> DataSlice: ...
    def is_entity_schema(self) -> DataSlice: ...
    def is_struct_schema(self) -> DataSlice: ...
    def is_primitive_schema(self) -> DataSlice: ...
    def is_primitive(self) -> DataSlice: ...
    def is_list(self) -> DataSlice: ...
    def is_dict(self) -> DataSlice: ...
    def is_entity(self) -> DataSlice: ...
    def is_empty(self) -> DataSlice: ...
    def is_mutable(self) -> DataSlice: ...
    def internal_is_itemid_schema(self) -> DataSlice: ...
    ...
    def resize(self, shape: _JaggedShape) -> DataSlice: ...
    def resize_as(self, shape_from: DataSlice) -> DataSlice: ...
    ...
    # NOTE: __iter__ is not defined in order to enable single-argument pattern
    # in parameterized tests.
    # In practice, this will not cause any type checker errors, because the
    # type checker will fall back on __getitem__ that proves iteration is
    # possible.
...
class DataBag(arolla.QValue):
    ...
    def uu(self, seed: str | DataSlice | None = '', *, schema: DataSlice | None = None, overwrite_schema: bool = False, **kwargs: Any) -> DataSlice: ...
    def uuobj(self, seed: str | DataSlice | None = '', **kwargs: Any) -> DataSlice: ...
    def uu_schema(self, seed: str | DataSlice | None = '', **attrs: Any) -> DataSlice: ...
