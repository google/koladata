...
from_py = py_conversions.from_py
...
def _get_sparse_py_object():
  a1 = _A(x=1.0, y=['a', 'b', None])  # pyrefly: ignore[bad-argument-type]
  a2 = _A(x=2.0)
...
class FromPyTest(parameterized.TestCase):
  ...
  def test_none_in_complex_structures(self, input_schema):
    ...
    from_py_obj = from_py(obj, schema=input_schema)
  ...
  def test_none_in_complex_structures_with_actual_schema(self):
    ...
    expected_schema = expected_obj.get_schema()
    from_py_obj = from_py(obj, schema=expected_schema)
  ...
  def test_object(self):
    ...
    ref = fns.obj().ref()
    testing.assert_equal(from_py([ref], from_dim=1), ds([ref]))
  ...
  def test_same_bag(self):
    ...
    res = from_py([[o1, o2], [l1, l2], [42]], from_dim=2)
    testing.assert_equivalent(
        res,
  ...
  def test_different_bags(self):
    ...
    res = from_py([[o1, o2], [42]], from_dim=2, schema=schema_constants.OBJECT)
    testing.assert_equal(
        res.no_bag(),
  ...
  def test_list_auto_schema(self):
    l = from_py([1, 2, 3], schema=None)
    testing.assert_equal(l[:].no_bag(), ds([1, 2, 3]))
    self.assertFalse(l.get_bag().is_mutable())

    l = from_py([1, 3.14], schema=None)
    ...
    with self.assertRaisesRegex(
      ...
      _ = from_py([[1, 2, 3], 4], from_dim=0, schema=None)

    with self.assertRaisesRegex(
        ValueError,
        'schema mismatch: expected list/tuple',
    ):
      _ = from_py([[1, 2, 3], 4], from_dim=1, schema=None)

  def test_list_with_none(self):
    l = from_py([None, [1, 2, 3], [4, 5]])
  ...
  def test_string_to_float64_fails(self):
    with self.assertRaisesRegex(ValueError, 'the schema is incompatible'):
      _ = from_py('3.14', schema=schema_constants.FLOAT64)
  ...
  def test_primitive_int_enum(self):
    ...
    testing.assert_equal(from_py(MyIntEnum.A, schema=None), ds(1))
    testing.assert_equal(from_py(MyIntEnum.B, schema=None), ds(2))
    testing.assert_equal(from_py(MyIntEnum.C, schema=None), ds(2**33))
  ...
  def test_primitive_str_enum(self):
    ...
    testing.assert_equal(from_py(MyStrEnum.A, schema=None), ds('a'))
    testing.assert_equal(from_py(MyStrEnum.B, schema=None), ds('b'))
...
assigned schema: MASK"""),
      ...
      from_py(b'xyz', schema=schema_constants.MASK)
...
assigned schema: INT32"""),
      ...
      from_py(3.14, schema=schema_constants.INT32)
    with self.assertRaisesRegex(
        ValueError,
        re.escape("""the schema is incompatible:
expected schema: FLOAT32
assigned schema: INT32"""),
  ...
  def test_list_from_dim(self):
    ...
    l0 = from_py(input_list, from_dim=0)
    ...
    l1 = from_py(input_list, from_dim=1)
  ...
  def test_list_from_dim_with_schema(self):
    ...
    l2 = from_py(input_list, schema=schema_constants.FLOAT64, from_dim=2)
    self.assertEqual(l2.get_ndim(), 2)
    testing.assert_equal(l2, ds([[1, 2], [3, 4]], schema_constants.FLOAT64))

    l3 = from_py(input_list, schema=schema_constants.OBJECT, from_dim=2)
  ...
  def test_dict_from_dim(self):
    ...
    d0 = from_py(input_dict, from_dim=0)
    inner_slice = d0[:]
    testing.assert_dicts_keys_equal(
    ...
    d1 = from_py(input_dict, from_dim=1)
    testing.assert_dicts_keys_equal(
  ...
  def test_from_dim_error(self):
    ...
    with self.assertRaisesRegex(
      ...
      _ = from_py([], from_dim=2, schema=schema)

  def test_none(self):
    item = from_py(None, schema=None)
    testing.assert_equal(item, ds(None))

  def test_none_object(self):
    item = from_py(None, schema=schema_constants.OBJECT)
  ...
  def test_entity_reference_with_schema(self):
    entity = fns.new(x=42).fork_bag()
    item = from_py(entity.ref(), schema=entity.get_schema())
  ...
  def test_obj_in_list_if_schema_provided(self):
    ...
    with self.subTest('entities mixed with dataclasses'):
      ...
      x = from_py([obj, entity], schema=schema, dict_as_obj=True)
    ...
    with self.subTest('entities mixed with dicts'):
      ...
      with self.assertRaisesRegex(
        ...
        _ = from_py([d, entity], schema=schema, dict_as_obj=True)
  ...
  def test_dict_as_obj_bag_adoption(self):
    obj_b = from_py({'x': 'abc'}, dict_as_obj=True)
    obj = from_py({'a': 42, 'b': obj_b}, dict_as_obj=True)
    testing.assert_equal(
  ...
  def test_dict_as_obj_dict_key_is_data_item(self):
    # Object.
    obj = from_py({ds('a'): 42}, dict_as_obj=True)
...
assigned schema: ENTITY(x=INT32)"""),
      ...
      _ = from_py(entity, schema=schema)
  ...
  def test_dataclasses_object_schema(self):
    obj = from_py(TestKlass(42, NestedKlass('abc'), b'xyz'))
...
assigned schema: ENTITY(a=FLOAT32)"""),
      ...
      _ = from_py(3.14, schema=schema)

  def test_list_of_dataclasses(self):
    obj = from_py([NestedKlass('a'), NestedKlass('b')], schema=None)
    nested = obj[:]
  ...
  def test_dataclasses_prevent_memory_leak(self):
    ...
    for _ in range(10):
      from_py(TestKlassInternals(42, 3.14))
    gc.collect()
  ...
  def test_single_empty_proto_message(self, schema):
    x = from_py(test_pb2.MessageA(), schema=schema)
  ...
  def test_single_proto(self, schema):
    x = from_py(_create_test_proto(), schema=schema)
    self.assertFalse(x.get_bag().is_mutable())
    self.assertEqual(x.get_ndim(), 0)
  ...
  def test_single_proto_auto_schema(self):
    x = from_py(_create_test_proto(), schema=None)
    self.assertFalse(x.get_bag().is_mutable())
    self.assertEqual(x.get_ndim(), 0)
  ...
  def test_list_of_protos(self, schema):
    x = from_py([_create_test_proto(), _create_test_proto()], schema=schema)
    x = x[:]
  ...
  def test_list_of_different_protos_with_object_schema(self):
    ...
    x = from_py([proto1, proto2], schema=schema_constants.OBJECT)
    x = x[:]
    self.assertEqual(x.S[0].some_text, 'thing 1')
  ...
  def test_sparse_list_of_protos_with_object_schema(self):
    x = from_py([_create_test_proto(), None], schema=schema_constants.OBJECT)
    y = from_py([None, _create_test_proto()], schema=schema_constants.OBJECT)
    testing.assert_equivalent(x[:].S[0], y[:].S[1])

  def test_list_of_proto_mixed_with_dataclasses(self):
    x = from_py([_create_test_proto(), _create_obj_like_proto()])
    x = x[:]
    self.assertEqual(x.S[0].some_text, 'thing 1')
  ...
  def test_dict_of_protos_mixed_with_dataclasses(self):
    x = from_py({'a': _create_test_proto(), 'b': _create_obj_like_proto()})
    self.assertEqual(x['a'].some_text, 'thing 1')
  ...
  def test_item_id(self):
    ...
    with self.subTest('proto'):
      ...
      x = from_py([p], itemid=parent_itemid)
  ...
  def test_deep_error(self, params):
    ...
    with self.assertRaisesRegex(ValueError, 'recursive .* cannot be converted'):
      from_py(input_obj)
    with self.assertRaisesRegex(ValueError, 'recursive .* cannot be converted'):
      from_py(input_obj, schema=schema)
    with self.assertRaisesRegex(ValueError, 'recursive .* cannot be converted'):
      from_py(input_obj, itemid=itemid)
  ...
  def test_deep_list_with_repetitions(self):
    ...
    testing.assert_equal(
        from_py(py_l, schema=schema)[:][:][:].no_bag(),
  ...
  def test_deep_object_repetitions(self):
    ...
    entity = from_py(py_d, dict_as_obj=True, schema=None)
    ...
    entity = from_py(py_d, dict_as_obj=True, schema=schema)
    testing.assert_equal(entity.x.x.abc.no_bag(), ds(42))
    testing.assert_equal(entity.x.y.abc.no_bag(), ds(42))
    testing.assert_equal(entity.y.x.abc.no_bag(), ds(42))
    testing.assert_equal(entity.y.y.abc.no_bag(), ds(42))
  ...
  def test_no_recursion_detected(self):
    ...
    with self.subTest('object'):
      ...
      _ = from_py(py_d2, dict_as_obj=True)
  ...
  def test_arg_errors_schema(self):
    ...
    with self.assertRaisesRegex(
      ...
      from_py([1, 2], schema=schema_constants.SCHEMA)
