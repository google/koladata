...
//
#ifndef PY_KOLADATA_BASE_TESTING_TEST_INVALID_UNICODE_OP_H_
#define PY_KOLADATA_BASE_TESTING_TEST_INVALID_UNICODE_OP_H_
...
#endif  // PY_KOLADATA_BASE_TESTING_TEST_INVALID_UNICODE_OP_H_
