...
(
  ...
  # Manually compile proto files for Python using a specific version of protoc.
  $PROTOC --python_out=. koladata/functor/parallel/execution_config.proto
  install -v -m 0644 -D koladata/functor/parallel/execution_config_pb2.py -t /build/pkg/koladata/functor/parallel
...
+from arolla.objects import objects as _  # load libobjects_so.so
