...
### `kd.expr.get_input_names(expr, container=<koladata.expr.input_container.InputContainer object at 0x30113aedc510>)` {#kd.expr.get_input_names}
...
### `kd.expr.sub_inputs(expr, container=<koladata.expr.input_container.InputContainer object at 0x30113aedc510>, /, **subs)` {#kd.expr.sub_inputs}
