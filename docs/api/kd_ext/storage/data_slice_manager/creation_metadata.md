...
# kd_ext.storage.data_slice_manager.CreationMetadata API

<pre class="no-copy"><code class="lang-text no-auto-prettify">Metadata about the creation of a DataSliceManager.
</code></pre>
