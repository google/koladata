...
# kd_ext.storage.data_slice_path.DictGetKeys API

<pre class="no-copy"><code class="lang-text no-auto-prettify">Action to get the keys of a Koda DICT data slice.
</code></pre>
...
### `DictGetKeys.evaluate(self, data_slice: kd.types.DataSlice) -> kd.types.DataSlice` {#kd_ext.storage.data_slice_path.DictGetKeys.evaluate}

<pre class="no-copy"><code class="lang-text no-auto-prettify">Evaluates the action on the given data slice.</code></pre>

### `DictGetKeys.get_subschema(self, schema: kd.types.DataItem) -> kd.types.DataItem` {#kd_ext.storage.data_slice_path.DictGetKeys.get_subschema}
...
### `DictGetKeys.get_subschema_bag(self, schema: kd.types.DataItem) -> kd.types.DataBag` {#kd_ext.storage.data_slice_path.DictGetKeys.get_subschema_bag}
...
### `DictGetKeys.get_subschema_operation(self) -> str` {#kd_ext.storage.data_slice_path.DictGetKeys.get_subschema_operation}
...
### `DictGetKeys.parse_from_data_slice_path_prefix(data_slice_path: str) -> tuple[DataSliceAction, str] | None` {#kd_ext.storage.data_slice_path.DictGetKeys.parse_from_data_slice_path_prefix}
