...
# kd_ext.storage.data_slice_path.DictGetValues API

<pre class="no-copy"><code class="lang-text no-auto-prettify">Action to get the values of a Koda DICT data slice.
</code></pre>
...
### `DictGetValues.evaluate(self, data_slice: kd.types.DataSlice) -> kd.types.DataSlice` {#kd_ext.storage.data_slice_path.DictGetValues.evaluate}

<pre class="no-copy"><code class="lang-text no-auto-prettify">Evaluates the action on the given data slice.</code></pre>

### `DictGetValues.get_subschema(self, schema: kd.types.DataItem) -> kd.types.DataItem` {#kd_ext.storage.data_slice_path.DictGetValues.get_subschema}
...
### `DictGetValues.get_subschema_bag(self, schema: kd.types.DataItem) -> kd.types.DataBag` {#kd_ext.storage.data_slice_path.DictGetValues.get_subschema_bag}
...
### `DictGetValues.get_subschema_operation(self) -> str` {#kd_ext.storage.data_slice_path.DictGetValues.get_subschema_operation}
...
### `DictGetValues.parse_from_data_slice_path_prefix(data_slice_path: str) -> tuple[DataSliceAction, str] | None` {#kd_ext.storage.data_slice_path.DictGetValues.parse_from_data_slice_path_prefix}
