...
# kd_ext.storage.data_slice_path.GetAttr API

<pre class="no-copy"><code class="lang-text no-auto-prettify">Action to get an attribute of a Koda entity data slice.
</code></pre>
...
### `GetAttr.__init__(self, attr_name: str) -> None` {#kd_ext.storage.data_slice_path.GetAttr.__init__}
...
### `GetAttr.debug_string(self) -> str` {#kd_ext.storage.data_slice_path.GetAttr.debug_string}
*No description*

### `GetAttr.evaluate(self, data_slice: kd.types.DataSlice) -> kd.types.DataSlice` {#kd_ext.storage.data_slice_path.GetAttr.evaluate}

<pre class="no-copy"><code class="lang-text no-auto-prettify">Evaluates the action on the given data slice.</code></pre>

### `GetAttr.get_subschema(self, schema: kd.types.DataItem) -> kd.types.DataItem` {#kd_ext.storage.data_slice_path.GetAttr.get_subschema}
...
### `GetAttr.get_subschema_bag(self, schema: kd.types.DataItem) -> kd.types.DataBag` {#kd_ext.storage.data_slice_path.GetAttr.get_subschema_bag}
...
### `GetAttr.get_subschema_operation(self) -> str` {#kd_ext.storage.data_slice_path.GetAttr.get_subschema_operation}
...
### `GetAttr.parse_from_data_slice_path_prefix(data_slice_path: str) -> tuple[DataSliceAction, str] | None` {#kd_ext.storage.data_slice_path.GetAttr.parse_from_data_slice_path_prefix}
