...
Alias for [kd.iterables.flat_map_chain](iterables.md#kd.iterables.flat_map_chain)

### `kd.functor.flat_map_interleaved(iterable, fn, value_type_as=None)` {#kd.functor.flat_map_interleaved}

Alias for [kd.iterables.flat_map_interleaved](iterables.md#kd.iterables.flat_map_interleaved)
...
Alias for [kd.iterables.for_](iterables.md#kd.iterables.for_)
...
Alias for [kd.iterables.while_](iterables.md#kd.iterables.while_)
